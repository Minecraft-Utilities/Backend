...
public final class ModelUtils {
    ...
    public static double[][] boxUv(int x, int y, int sizeX, int sizeY, int sizeZ) {
        return new double[][]{{x, y, x + sizeX, y + sizeY},                           // north (-Z front)
    ...
    public static void addBox(List<Face> faces, double px, double py, double pz, double w, double h, double d, double[][] uvs) {
        ...
        faces.add(new Face(new Vector3(x1, y1, pz), new Vector3(x1, y1, z1), new Vector3(x1, py, pz), new Vector3(x1, py, z1), uvs[2][0], uvs[2][1], uvs[2][2], uvs[2][3], new Vector3(1, 0, 0)));
    }
}
