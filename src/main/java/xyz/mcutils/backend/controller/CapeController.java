...
public class CapeController {
    ...
    public ResponseEntity<VanillaCape> getCape(@Parameter(description = "The UUID of the cape") @PathVariable UUID id) {
        return ResponseEntity.ok().body(capeService.getCape(id));
    }
